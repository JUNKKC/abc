...
Scanner sc = new Scanner(System.in);
  ...
  String[] user_create() {
    ...
    System.out.println("[시스템] 유닛 [이름] 을 입력해 주세요 :"+sc.next());
    System.out.println("[시스템] 유닛 [공격력] 을 입력해 주세요 :"+sc.next());
    System.out.println("[시스템] 유닛 [방어력] 을 입력해 주세요 :"+sc.next());
    System.out.println("[시스템] 유닛 [체력] 을 입력해 주세요 :"+sc.next());
    if (int i = 0; user_create())
  ...
  void user_print(String[] user) {
    ...
    System.out.printf("[안내] %s 유닛이 게임에 참여하였습니다.%n [공격력] : %s%n [방어력] : %s%n [체력] : %s%n",name,ad,def,hp);
  }
